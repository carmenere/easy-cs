...
**Future** (in programming language) is an object that stores result of async operation and which can be accessed later.<br>
**Future** is created and returned to caller **before** async operation.<br>
