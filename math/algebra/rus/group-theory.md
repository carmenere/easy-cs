...
- [Связь перестановок с вращением](#связь-перестановок-с-вращением)
...
Все перестановки делятся на **чётные** и **нечётные**:
...
Это следует из **главного свойства знака** перестановки:
**знак** *произведения* перестановок равен *произведению* их **знаков**: $`\text{sgn}(\phi \circ \psi) = \text{sgn}(\phi) * \text{sgn}(\psi)`$.<br>

Поэтому, знак произведения **чётной** и **нечётной** перестановок равен произведению $`1 * (-1) = -1`$.<br>
...
# Связь перестановок с вращением
Перестановка:<br>
...
описывает поворот любой фигуры обладающией вращательной симметрией (**n**-угольника, ожерелья из **n** бусинок, шестерёнки с **n** зубцами) на угол $`{\displaystyle {\tfrac {360^{\circ }}{n}}}`$ вокруг своего центра.<br>
