...
- если перестановка **чётная**, то ее знак **1**: $`sgn \space \phi = 1`$;
- если перестановка **нечётная**, то ее знак **-1**: $`sgn \space \phi = 1`$;
...
**знак** *произведения* перестановок равен *произведению* их **знаков**: $`sgn(\phi \circ \psi) = sgn(\phi) * sgn(\psi)`$.<br>
