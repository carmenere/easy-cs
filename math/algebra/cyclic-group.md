...
1. По **горизонтали** и по **вертикали** выписываются **все** элементы группы в **одинаковом** порядке. Обычно, **первым** элементом располагают **нейтральный** элемент $`e`$.
2. **Элемент** $i*j$ таблицы Кэли, стоящий на пересечении **i**-той строки и **j**-того столбца, равен **результату** выполнения **групповой** операции **i**-го элемента с **j**-тым элементом группы.
