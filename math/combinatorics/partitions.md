...
# Раскладки
Допустим, есть **мульти**множество $`X = \{1,1,2,2,\dots\}`$ мощности $`n`$, т.е. $`|X| = n`$. Используется **мультимножество**, т.к. допускаются **повторения** элементов. <br>
