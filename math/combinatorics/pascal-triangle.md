...
Будем последовательно записывать в каждую клетку таблицы число способов добраться до неё.<br>
...
Чтобы в неё попасть, мы должны сначала оказаться либо **над** ней, либо **слева** от неё. Поэтому существует **1 + 1** способа попасть в неё. Это правило справедливо для каждой клетки, поэтому в **каждой** клетке будет число, равное **сумме двух чисел**: числа в клетке **над** ней и числа в клетке **слева** от неё.<br>
...
Согласно формуле **перестановок с повторениями**, мы получим: $`P_{k,m}^{k+m} = {\frac {(k+m)!}{k! \cdot m!}}`$.<br>
